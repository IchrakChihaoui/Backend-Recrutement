...
var UserModel = require('./../models/user'); // hna bech tnadi l model li bech ta3ml alaha l crud (user)
...
router.post('/user/save', function(req, res) {
    ...
    var newUser = new UserModel(); //ism l model li importetaha l fog
       // kol attribute mil model thotila req.body.attribue li fil model bech ay haja tjih ysobha fil attribute hakka
       newUser.mail = req.body.mail;
       newUser.password = req.body.password;
    
       
       newUser.save(function(err, data){ // ba3d taml .save hedhi predeifni tsoblik fil base tab3adh les information
           if(err){
               console.log(error);
           }
           else{
